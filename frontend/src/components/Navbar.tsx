...
export const Navbar = () => {
  ...
  return (
    <header
      className={`min-h-16 md:h-16 w-full flex items-center border-b-3 border-fog/50 sticky top-0 z-50 rounded-b-md transition-all duration-300 bg-night ${
        isMenuOpen
    ...
    >
      <nav
        ...
        className="flex items-center justify-between max-w-5xl mx-auto w-full px-3"
      >
        {/* Logo */}
        ...
        {/* Mobile menu */}
        <div
          className={`absolute top-full left-0 w-full bg-deep-ocean/90 backdrop-blur-sm flex flex-col items-center gap-4 px-4 p-4 md:hidden overflow-hidden transition-all duration-300 ease-in-out rounded-b-3xl border-4 border-orchid/50 border-t-0 ${
            isMenuOpen
