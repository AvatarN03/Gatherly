...
import { useManageCommunityQuery } from "../../hooks/useCommunities";
    ...
    return (
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            <div className="h-20 w-20 rounded-xl bg-slate" />
    ...
    return (
      <div className="flex flex-col items-center gap-3 rounded-xl border border-cocoa/30 bg-cocoa/5 py-14 text-center">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-cocoa/15">
          <AlertCircle className="h-6 w-6 text-cocoa" />
        </div>

        <div>
          <p className="font-medium text-mist">
            Couldn't load your managed communities
          </p>
        ...
        <button
          ...
          className="mt-1 rounded-lg border border-slate/70 bg-deep-ocean px-4 py-2 text-sm font-medium text-fog hover:bg-slate/40 disabled:opacity-60"
        >
    ...
    return (
      <div className="flex flex-col items-center gap-3 py-16 text-center">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-orchid/15">
          <ShieldCheck className="h-6 w-6 text-orchid" />
        </div>

        <p className="text-fog">
          You're not managing any communities yet.
        </p>
